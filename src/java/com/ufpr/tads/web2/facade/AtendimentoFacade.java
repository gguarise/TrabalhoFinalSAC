...
public class AtendimentoFacade {
    ...
    public static ArrayList<Atendimento> getListaPorCliente(Cliente cliente) throws AtendimentoException
    {
        ...
        {
            throw new AtendimentoException("Erro ao retornar lista de atendimentos de cliente: " + cliente.getIdCliente(), e);
        }
    }
    ...
    public static ArrayList<Atendimento> getListaPorFuncionario(Funcionario funcionario) throws AtendimentoException
    {
        ...
        {
            AtendimentoDao atendimentoDao = new AtendimentoDao();
            ArrayList<Atendimento> listaAtendimentosPorFuncionario = atendimentoDao.retornaAtendimentosPorFuncionario(funcionario);
            return listaAtendimentosPorFuncionario;
        }
        catch(SQLException | ClassNotFoundException e)
        {
            throw new AtendimentoException("Erro ao retornar lista de atendimentos de funcionario: " + funcionario.getIdFuncionario(), e);
        }
    }
    ...
    public static ArrayList<Atendimento> getListaPorSituacao(Situacao situacao) throws AtendimentoException
    {
        ...
        {
            AtendimentoDao atendimentoDao = new AtendimentoDao();
            ArrayList<Atendimento> listaAtendimentosPorSituacao = atendimentoDao.retornaAtendimentosPorSituacao(situacao);
            return listaAtendimentosPorSituacao;
        }
        catch(SQLException | ClassNotFoundException e)
        {
            throw new AtendimentoException("Erro ao retornar lista de atendimentos de situacao: " + situacao.getIdSituacao(), e);
        }
    }
