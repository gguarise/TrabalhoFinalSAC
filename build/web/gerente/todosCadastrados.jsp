                ...
                <tbody>
                    <c:forEach var="funcionario" items="${listaFuncionarios}">  
                        <tr>
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/GerenteServlet?action=show&idCadastrado=${funcionario.idFuncionario}"><img src="<c:url value="/img/visualizar.png"/>" width="30" height="30"/></a>
                                ...
                                <a href="${pageContext.request.contextPath}/GerenteServlet?action=delete&idFuncionario=${funcionario.idFuncionario}" 
                    ...
                    <c:forEach var="gerente" items="${listaGerentes}">  
                        <tr>
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/GerenteServlet?action=show&idGerente=${gerente.idGerente}"><img src="<c:url value="/img/visualizar.png"/>" width="30" height="30"/></a>
                                ...
                                <a href="${pageContext.request.contextPath}/GerenteServlet?action=delete&idGerente=${gerente.idGerente}" 
                                   onclick="return confirm('Confirma a exclusão do Funcionário '${gerente.primeiroNome} ${gerente.sobreNome}?')'">
                                    <img src="<c:url value="/img/remover.png"/>" width="30" height="30"/>
                                </a>
                            </td>
                        </tr>
