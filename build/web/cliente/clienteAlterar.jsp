<%-- 
    ...
    Created on : 28/07/2021, 21:13:25
    Author     : jessi
--%>
    ...
    <div class='wrapper page-extra'>
     <nav class='top-section navbar'>
       ...
       <div class="container">
        <div class="row login">
         <div class="col-md-12"> 
         <h1 class="title h1 m-0 mt-4 text-center">Alterar dados</h1><br>
            ...
            <div class="form-group">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group ">
                      ...
                      <input type="tel" class="form-control" id="phone" name="phone" required="true" data-mask="(00) 00000-0009" data-error="phone_required_field phone_phone_field" value="" minlength="8" autocomplete="off" maxlength="15">
                      <p class="error"></p>
                    </div>
                  </div>
                  <div class="col-sm-6">
               ...
               <div class="form-group">
                <div class="row align-items-center">
                  <div class="col-sm-6 mt-4 mt-sm-0"><br>
                    <button type="submit" class="btn btn-secondary btn-lg btn-block"> Cancelar </button>
                  </div>
                </div>
              </div>
             </div>
              <div class="col-sm-6">
               <div class="form-group">
                <div class="row align-items-center">
                  <div class="col-sm-6 mt-4 mt-sm-0"><br>
                    <button type="submit" class="btn buttons btn-lg btn-block"> Salvar </button>
                  </div>
                </div>
              </div>
             </div>
