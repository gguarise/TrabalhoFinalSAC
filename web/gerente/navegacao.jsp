...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="${pageContext.request.contextPath}/GerenteServlet?action=listarCategorias">Categorias de Produto</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="${pageContext.request.contextPath}/GerenteServlet?action=listarProdutos ">Produtos</a>
        </li>
        <li class="nav-item">
